...
export const SuccessState = ({title}: Props) => {
  ...
  return (
    <div className="flex flex-1 flex-col justify-center md:justify-start items-center mt-16 mb-12 animate-jump-in animate-duration-200">
      <h2 className="hidden font-bebas text-[34px] text-aqua tracking-widest mt-1 mb-[52px] md:block">
        Lite<span className="font-light">flix</span>
      </h2>
      <div className="flex flex-col gap-y-4 items-center mb-[72px] text-center">
